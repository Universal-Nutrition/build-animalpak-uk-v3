...
class Header extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.addEventListener("mouseleave", (0,_helpers_utils_js__WEBPACK_IMPORTED_MODULE_0__.debounce)(this.mouseLeaveEvent.bind(this), 50));
  }
  toggleExpanded() {
    ...
    elements.forEach(element => {
      ...
      element.addEventListener("mouseover", () => {
        [...document.querySelectorAll(".mega-nav__item")].forEach(el => el.classList.remove("active"));
        const btn = element.querySelector("[meganav_heading_index]");
        if (btn) btn.classList.add("active");
        document.querySelectorAll(".mega-nav__dropdown").forEach(el => el.classList.add("hidden"));
